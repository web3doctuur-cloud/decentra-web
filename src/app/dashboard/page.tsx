...
import { FaLock, FaArrowLeft, FaPlay, FaClock, FaEthereum, FaUserGraduate } from "react-icons/fa";
...
export default function CourseViewPage() {
  ...
  // Important: Get the id correctly
  ...
  useEffect(() => {
    // Debug logging
    console.log("=== Course View Page Debug ===");
  ...
  const checkAuthAndLoad = async () => {
    ...
    if (currentUser && courseId && courseId !== "undefined") {
  ...
  const loadCourse = async () => {
    if (!courseId || courseId === "undefined") {
      console.error("Cannot load course: Invalid ID");
      router.push("/courses");
      return;
    }
